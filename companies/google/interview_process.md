...
> **Role Target**: Product Manager (PM)
...
|---|---|---|---|
| **1. Recruiter Screen** | 30 min | Phone Call | Background, motivation for Google, high-level fit, and compensation expectations. |
| **2. Phone Screen** | 45 min | Video Call | Usually with a current PM. Focuses on Product Design, Estimation, or rapid-fire behavioral questions to gauge foundational competence. |
| **3. Virtual Onsite Loop** | 4-6 hours | 4-6 Video Calls (45m each) | Comprehensive assessment across Product Design, Analytics, Technical, and Googleyness. |
...
| Do | Don't |
|---|---|
| **Start with the User**: Always explicitly define user segments and pain points before proposing features. | **Jump to Solutions**: Never start listing features immediately after hearing the prompt. |
| **Use Frameworks**: Structure your answers clearly (e.g., CIRCLES, STAR) to navigate ambiguity logically. | **Be Dogmatic**: Don't rigidly defend a bad idea if the interviewer provides new data or hints. Show intellectual humility. |
| **Think 10x**: Propose ambitious, "moonshot" solutions in the visionary phase of product design. | **Focus on Incrementalism**: Avoid proposing only safe, 10% optimizations unless specifically asked for execution constraints. |
| **Lead with Data**: Explain how you would measure success or failure using specific metrics. | **Assume the Interviewer's Intent**: Ask clarifying questions to narrow down broad, ambiguous prompts (a hallmark of Google interviews). |
...
- [Exponent Google PM Guide](https://tryexponent.com/guides/google-pm-interview)
- [Stratechery: Google, Nvidia, OpenAI](../_raw/Google_Nvidia_and_OpenAI.md)
