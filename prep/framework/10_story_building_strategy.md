...
2.  **Mission**: "What was the umbrella mission I was driving?" (The top-level arc that frames the work and stakes).
3.  **Overview**: "How do I summarize that mission in 20-40 seconds?" (The top-level intro you actually say out loud in an interview).
4.  **Epic**: "What specific workstream or phase was I leading?" (A multi-quarter slice within the mission; contains multiple stories).
5.  **Specific Story**: "What specific moment illustrates the question asked?" (The conflict/decision).
6.  **STAR Format**: The mechanism of delivery.
7.  **Principle**: The underlying mental model or value demonstrated.

### Visual Model
```mermaid
graph TD
    A[Company Context] --> B[Mission]
    B --> C[Overview]
    C --> D[Epic]
    D --> E[Specific Story Moment]
    E --> F[STAR Delivery]
    F --> G[Leadership Principle]
```
...
### Layer 2: The Mission, Overview, and Epic
#### Layer 2A: The Mission (Umbrella container)
A Mission is the umbrella arc behind a body of work. It provides the “why”, constraints, and stakes across multiple phases.
*   *Definition*: A strategic mission that may span **multiple years** and contains multiple epics.
*   *Examples*:
    *   "Responsible & Private AI (post-iOS14 / regulatory era)"
    *   "WhatsApp AI for Business (building Click-to-Message into a scaled revenue surface)"
    *   "Llama Safety & Human Alignment (frontier model safety program)"

#### Layer 2B: The Overview (What you actually say)
The Overview is the short interview-safe summary of the mission.
*   *Definition*: A 20-40 second intro built as **Setup -> Tension -> My role -> Resolution**.
*   *Purpose*: It helps you open strong, then zoom into the right epic or story based on the question.

#### Layer 2C: The Epic (Multi-quarter workstream)
An Epic is a sustained, multi-quarter initiative with high stakes. It is the "container" for multiple stories within a mission.
*   *Definition*: A strategic workstream that typically spans **multiple quarters** (often 1–6 quarters).
*   *Example Epics*:
    *   "Marketing Messages (MM) WCA Launch"
    *   "VRS (Variance Reduction System) for HUD/HEC compliance"
